const CONST_CSV = """
,反黑箱服貿協議・守護民主日與夜,,,"g0v.today 每 3 分鐘更新",,,"g0v.today 每 3 分鐘更新"
...
http://ecfa.speaking.tw/imho.php,"服貿東西軍 ",,,"更新前請 *務必* 先刷新整頁試算表再改，感謝！",,,"更新前請 *務必* 先刷新整頁試算表再改，感謝！"
https://sites.google.com/site/twdstreet/,公民審服貿,,街頭民主審議:info,"影音更新時請記得 *保留前方空白* 和 /embed/ 格式, 把 youtube watch?v=XXXXXX 的 XXXXX 放到 /embed/ 後即可。ustream 也是使用 /embed/ (按「Share/共用」可取得 embed code) — 然後更新 D 欄的「時間」和 F 欄的「更新人」。感謝!",,,"影音更新時請記得 *保留前方空白* 和 /embed/ 格式, 把 youtube watch?v=XXXXXX 的 XXXXX 放到 /embed/ 後即可。ustream 也是使用 /embed/ (按「Share/共用」可取得 embed code) — 然後更新 D 欄的「時間」和 F 欄的「更新人」。感謝!"
,行動,,,,,,

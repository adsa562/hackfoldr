refresh ::
	...
	git commit -am "`date`" && git push && ./deploy && git checkout gh-pages && git cherry-pick 8506d600ef8e11a1daee777fbca6aad0d1f2ff1f && git push origin gh-pages && git checkout master
